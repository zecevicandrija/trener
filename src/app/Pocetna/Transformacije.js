...
const clients = [
  {
    ...
    quote: "Mislio sam da je genetika problem. Ispostavilo se da je problem bio nedostatak sistema."
  },
  {
    id: 2,
    name: "STEFAN R.",
    program: "PLAN TRENINGA",
    ...
    quote: "Brutalno teško, ali vredno svake kapi znoja. Osećam se kao nova osoba."
  }
];
    ...
    >
      ...
      >
        ...
        <div className={styles.imageBefore}>
            ...
            <span className={styles.labelBefore}>PRE</span>
        </div>
        ...
        >
            ...
            <span className={styles.labelAfter}>POSLE</span>
        </div>
        ...
        <div className={styles.container}>
            <div className={styles.header}>
                ...
                <motion.h2 
                    ...
                    whileInView={{ opacity: 1, y: 0 }}
                >
                    REDEFINIŠI SVOJ <br/> <span className={styles.neonText}>POTENCIJAL</span>
                </motion.h2>
            </div>
            ...
            >
                <div className={styles.ctaContent}>
                    <h3>SPREMAN DA POSTANEŠ SLEDEĆA PRIČA?</h3>
                    <p>Ne čekaj ponedeljak. Ne čekaj "pravo vreme". Vreme curi.</p>
                    <button className={styles.ctaButton}>
                        ZAKAŽI KONSULTACIJE <ArrowRight />
                    </button>
                </div>
            </motion.div>
        </div>
